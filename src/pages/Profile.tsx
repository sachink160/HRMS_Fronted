...
import { User, Phone, Mail, Save, Camera, Eye } from 'lucide-react';
...
export const Profile: React.FC = () => {
    ...
    try {
      switch (type) {
        case 'profile':
          ...
          break;
        case 'aadhaarFront':
          await userService.uploadAadhaarFront(file);
          break;
        case 'aadhaarBack':
          await userService.uploadAadhaarBack(file);
          break;
        case 'pan':
          await userService.uploadPan(file);
          break;
      }
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">{user?.role === 'admin' ? 'Administrator' : 'Employee'}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  value={user?.email || ''}
                  disabled
                  className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-700 text-gray-500 dark:text-gray-400 sm:text-sm"
                />
              </div>
            ...
            <div className="md:col-span-1">
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  required
                  className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
            ...
            <div className="md:col-span-1">
              ...
              <input
                ...
                disabled
                className="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 sm:text-sm"
              />
            </div>
      ...
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg transition-colors duration-200">
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Identity Documents</h2>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
